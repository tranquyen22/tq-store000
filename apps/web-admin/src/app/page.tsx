...
import { DisputeRefundCenter } from '../components/DisputeRefundCenter';
import { KYCComplianceTaxExport } from '../components/KYCComplianceTaxExport';
...
export default function SuperAdminMainDashboardPage() {
  return (
    <div className="min-h-screen flex flex-col bg-slate-50 dark:bg-slate-950">
      
      {/* Admin Header */}
      <AdminHeader adminName="Super Admin Trần Văn Quyền" isMaintenanceActive={false} />

      {/* Main Operational Container */}
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 flex-1 w-full space-y-6">
        
        {/* Realtime Live Map Radar & SOS Emergency Panel */}
        <LiveMapCenter />

        {/* Maintenance Countdown Scheduler & Feature Toggles */}
        <SystemConfigMaintenance />

        {/* Dispute Resolution Ticket Center & Automated Wallet Refund */}
        <DisputeRefundCenter />

        {/* KYC Partner Onboarding Approvals & Regulatory Tax Reports Export (XML & Excel) */}
        <KYCComplianceTaxExport />
